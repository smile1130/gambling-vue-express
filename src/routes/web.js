...
router.get('/support/livechat', homeController.livechatsupport);
...
router.get('/knowledge/withdraw', homeController.withdrawknowledge);
router.get('/knowledge/withdrawissue', homeController.withdrawissueknowledge);
router.get('/selftutorial/index', homeController.selftutorialindex);
router.get('/tutorial/index', homeController.tutorialindexhelp);
